...
import { allScenarios, Message, Scenario } from '@/data/mini-game/story'
...
export default function StoryScreen() {
  ...
  const initializeGame = () => {
    ...
    const welcomeMessage: Message = {
      id: '0',
      text: `Chào bạn! Mình là MathKids. Hôm nay chúng ta sẽ cùng học toán học cấp 2 qua ${SCENARIOS_PER_GAME} tình huống thực tế nhé! 📚`,
      isBot: true,
    }
      ...
      return (
        <View key={message.id} className="flex-row mb-4">
          ...
          <View className="flex-1">
            <Text className="text-sm font-semibold text-gray-800 mb-1">MathKids</Text>
