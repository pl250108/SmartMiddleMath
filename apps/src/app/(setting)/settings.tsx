  ...
  return (
    <SafeAreaView className="bg-white h-full relative flex-1">
      ...
      <View className="mx-4 space-y-4 mt-12">
        <View className="flex-row justify-between bg-[#FF631514] px-5 py-4 rounded-2xl border border-[#FF63151F]">
        ...
        <View className="flex-row justify-between bg-[#FF631514] px-5 py-4 rounded-2xl border border-[#FF63151F] mt-2">
          <View className="flex-row items-center gap-1">
            <IconBook />
